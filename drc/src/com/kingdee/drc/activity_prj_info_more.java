...
public class activity_prj_info_more extends Activity  implements OnItemClickListener {
	private MyListView  listView_2;    //listView_1,   , listView_3
	private ArrayList<Map<String, String>> listData2;   //listData, listData2, listData3
